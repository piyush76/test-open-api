...
public class UserOpsEntityController {
    ...
    @Operation(summary = "Get User Operations Entity", description = "Retrieves the operations entity for a given user and company")
    @ApiResponses(value = {
    ...
    public ResponseEntity<UserOpsEntity> getUserOpsEntitybyUserAndCompany(
        ...
        final UserOpsEntity userOpsEntity = this.service.getUserOpsEntity(userId, companyId);
